...
After signing and submitting the serialized transaction from the buy step, call this endpoint with the \`downloadToken\` from the buy response and the \`txSignature\` from the on-chain submission.
